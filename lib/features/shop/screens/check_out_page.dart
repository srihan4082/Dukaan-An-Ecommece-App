...
import '../../personalization/screens/add_address.dart';
import '../../../features/authentication/screens/unpaid.dart';
...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  List<Product> products = [
    Product('images/headphone_9.png',
        'Boat roackerz 400 On-Ear Bluetooth Headphones', 'description', 45),
    Product('images/headphone_9.png',
        'Boat roackerz 100 On-Ear Bluetooth Headphones', 'description', 22),
    Product('images/headphone_9.png',
        'Boat roackerz 300 On-Ear Bluetooth Headphones', 'description', 58)
  ];
